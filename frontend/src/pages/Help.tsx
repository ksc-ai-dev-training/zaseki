          ...
          <>
            ...
            <Section title="マイプロフィールの設定">
              ...
              <ul className="list-disc space-y-1 pl-5">
                ...
                <li>座席表で他の利用者の氏名が表示されている座席（使用中・固定座席・プロジェクト座席で個人が確定している座席）をクリックすると、その利用者のプロフィール（氏名・所属・生年月日・趣味）を見ることができます（2026-09-25追加）。
                  <div className="mt-2 max-w-md">
          ...
          <>
            <Section title="プロジェクト座席の運用">
              ...
              <ol className="list-decimal space-y-3 pl-5">
                ...
                <li>期間が複数あるときは期間タブで対象を切り替えられます。その下の「曜日で絞り込み」「状態」「エリア」「プロジェクト名」は、曜日調整表・確定した出社曜日・座席割り当ての3つの一覧すべてに共通して効く絞り込みです（「曜日で絞り込み」は絞り込みに加えて、後述する座席の島の例外編集の対象曜日の指定にも使います）。</li>
