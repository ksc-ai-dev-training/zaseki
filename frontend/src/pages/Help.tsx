          ...
          <>
            ...
            <Section title="マイプロフィールの設定">
              <ol className="list-decimal space-y-3 pl-5">
                <li>サイドバーの「マイプロフィール」を開きます。自分のアイコン画像・生年月日（月日のみ）を登録できます（いずれも任意項目）。
        ...
        {tab === 'pmpl' && (
          <>
            ...
            <Section title="メンバーへの座席確保">
              ...
              <ol className="list-decimal space-y-3 pl-5">
                <li>「割り当てる座席」列のプルダウンから座席を選び、「この内容で一括確保する」でまとめて確保します。前回サイクルの座席割当があるプロジェクトでは「前回の座席をコピーする」で、前回と同じ座席番号が今回の座席の島にも含まれるメンバーの分だけ自動的に選択できます。固定座席あり・在宅のため不要のメンバーも同じ表に表示され、確保状況を一目で確認できます。
                  <div className="mt-2 max-w-md">
                    <Screenshot src="/help/assign-01-table.png" caption="メンバーへの座席確保（座席の確保状況・割り当てる座席・在宅のため不要）" />
                  </div>
                </li>
            ...
            <Section title="在宅のため座席が不要なメンバーの設定">
              <p>ずっと在宅勤務でプロジェクト座席が不要なメンバーは、「メンバーへの座席確保」の一覧にある「在宅のため不要」チェックを入れます。</p>
              <div className="mt-2 max-w-md">
                <Screenshot src="/help/assign-01-table.png" caption="「在宅のため不要」は、メンバーへの座席確保と同じ表のチェック欄で設定する" />
              </div>
              <ul className="list-disc space-y-1 pl-5">
          ...
          <>
            <Section title="プロジェクト座席の運用">
              ...
              <ol className="list-decimal space-y-3 pl-5">
                ...
                <li>各プロジェクトの状態（アンケート回答受付中・曜日確定済み・座席割当済み）や席決め担当、必要座席数などは「座席割り当て」の一覧でまとめて確認できます。未回答のプロジェクトが残っている場合は、一覧の「リマインドを送る」から任意のタイミングで催促を送れます（共通Slackチャンネルへ通知）。必要座席数は、固定座席保有者・在宅のため不要なメンバーを除いた人数から自動算出されるので、例外的に上書きしたい場合のみ「人数を修正」を使います（ただし実際に座席の島を割り当てる際は、その時点の実際のメンバー構成が優先されます）。
                  <div className="mt-2 max-w-md">
