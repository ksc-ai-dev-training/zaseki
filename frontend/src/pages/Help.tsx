        ...
        {tab === 'pmpl' && (
          <>
            ...
            <Section title="複数人の代理予約（フリー座席）">
              <p>座席の島の割当を経由せず、通常のフリー座席を複数のメンバーへその場で代理予約したい場合に使います。空き状況・予約（S-02）のフロアマップ表示上部にある「複数人の代理予約（PJメンバー）」ボタンから操作します（PJ席決担当、または「席決めを任せる」を有効にされたメンバーに表示されます）。</p>
              <ol className="list-decimal space-y-1 pl-5">
                <li>ボタンを押し、対象プロジェクトと対象メンバー（複数選択可）を選んで「フロアマップで座席を選ぶ」を押します。</li>
                <li>画面上部の日付を切り替えながら、その日に空いているフリー座席をクリックし、割り当てる相手を選びます。1回のクリックにつき1人・1日・1座席が確保されます。</li>
                <li>日付を変えて同じ手順を繰り返せます。同じ人に複数の日付・座席を確保することも、日によって異なる座席を割り当てることもできます。</li>
