    ...
    <div>
      ...
      <div className="max-w-3xl space-y-5 p-6">
        ...
        {tab === 'pmpl' && (
          <>
            <Note>
              プロジェクトの作成者、および「席決め」権限を付与されたメンバーが行う操作です（作成者は既定でPMとして登録されます）。サイドバーの「プロジェクト座席」から開きます。複数プロジェクトを兼務している場合は、プロジェクトごとにセクションが分かれます。画面上部の「新しいプロジェクトを作成」から、誰でも新しいプロジェクトを作成できます。
            </Note>
            ...
            <Section title="メンバー管理（席決め権限）">
              <p>プロジェクトの作成者のみが操作できます。メンバー一覧の「席決めを任せる」チェックを入れると、そのメンバーにも下記の座席確保操作を任せられます（管理部の承認は不要）。</p>
            </Section>

            <Section title="メンバーへの座席確保">
              <p>座席の島の割当が完了した四半期に限り、プロジェクトの作成者または席決め権限を持つメンバーが操作できます。</p>
              <ol className="list-decimal space-y-1 pl-5">
            ...
            <Section title="複数人の代理予約（フリー座席）">
              <p>座席の島の割当を経由せず、通常のフリー座席を複数のメンバーへその場で代理予約したい場合に使います。空き状況・予約のフロアマップ表示上部にある「複数人の代理予約（PJメンバー）」ボタンから操作します（プロジェクトの作成者、または「席決めを任せる」を有効にされたメンバーに表示されます）。</p>
              <ol className="list-decimal space-y-1 pl-5">
